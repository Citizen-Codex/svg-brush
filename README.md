...
![SVG Brush Demo](demo-preview.png) _(Demo available at localhost:5173)_
...
```svelte
<script>
	import { SvgCanvas, BrushSelector, BrushPresets, BackboneDeformation } from 'svg-brush';
...
// Apply deformation
const deformedPoints = BackboneDeformation.deformBrush(brush, userPath, options);
```
...
// Create a custom brush with straight backbone
const customBrush: BrushDefinition = {
	id: 'custom',
	name: 'Custom Brush',
	backbone: createStraightBackbone(100),
